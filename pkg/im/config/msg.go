...
func (c *Context) UpdateIMToken(req UpdateIMTokenReq) (*UpdateIMTokenResp, error) {
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/user/token", []byte(util.ToJson(map[string]interface{}{
		"uid":          req.UID,
		"token":        req.Token,
...
func (c *Context) QuitUserDevice(uid string, deviceFlag int) error {
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/user/device_quit", []byte(util.ToJson(map[string]interface{}{
		"uid":         uid,
...
func (c *Context) SendMessageBatch(req *MsgSendBatch) error {
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/message/sendbatch", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	if resp.StatusCode != http.StatusOK {
...
func (c *Context) SendMessageWithResult(req *MsgSendReq) (*MsgSendResp, error) {
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/message/send", []byte(util.ToJson(req)), nil)
	if err != nil {
		return nil, err
	}
	if resp.StatusCode != http.StatusOK {
...
func (c *Context) IMCreateOrUpdateChannelInfo(req *ChannelInfoCreateReq) error {
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/info", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
...
func (c *Context) IMCreateOrUpdateChannel(req *ChannelCreateReq) error {
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMBlacklistAdd(req ChannelBlacklistReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/blacklist_add", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMBlacklistSet(req ChannelBlacklistReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/blacklist_set", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMBlacklistRemove(req ChannelBlacklistReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/blacklist_remove", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMWhitelistAdd(req ChannelWhitelistReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/whitelist_add", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMWhitelistSet(req ChannelWhitelistReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/whitelist_set", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMWhitelistRemove(req ChannelWhitelistReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/whitelist_remove", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMAddSubscriber(req *SubscriberAddReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/subscriber_add", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	if resp.StatusCode != http.StatusOK {
...
func (c *Context) IMRemoveSubscriber(req *SubscriberRemoveReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/subscriber_remove", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMGetConversations(uid string) ([]*ConversationResp, error) {
	...
	resp, err := network.Get(c.cfg.GothIM.APIURL+"/conversations", map[string]string{
		"uid": uid,
	}, nil)
	if err != nil {
		return nil, err
...
func (c *Context) IMClearConversationUnread(req ClearConversationUnreadReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/conversations/setUnread", []byte(util.ToJson(req)), nil)
	if err != nil {
		return nil
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMDeleteConversation(req DeleteConversationReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/conversations/delete", []byte(util.ToJson(req)), nil)
	if err != nil {
		return nil
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMSyncUserConversation(uid string, version int64, msgCount int64, lastMsgSeqs string, larges []*Channel) ([]*SyncUserConversationResp, error) {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/conversation/sync", []byte(util.ToJson(map[string]interface{}{
		"uid":           uid,
		"version":       version,
...
func (c *Context) IMSyncChannelMessage(req SyncChannelMessageReq) (*SyncChannelMessageResp, error) {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/channel/messagesync", []byte(util.ToJson(req)), nil)
	if err != nil {
		return nil, err
	}
	err = c.handlerIMError(resp)
...
func (c *Context) IMSyncMessage(req *MsgSyncReq) ([]*MessageResp, error) {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/message/sync", []byte(util.ToJson(req)), nil)
	if err != nil {
		return nil, err
	}
	err = c.handlerIMError(resp)
...
func (c *Context) IMSyncMessageAck(req *SyncackReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/message/syncack", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMRevokeMessage(req *MessageRevokeReq) error {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/message/revoke", []byte(util.ToJson(req)), nil)
	if err != nil {
		return err
	}
	return c.handlerIMError(resp)
...
func (c *Context) IMSOnlineStatus(uids []string) ([]*OnlinestatusResp, error) {
	...
	resp, err := network.Post(c.cfg.GothIM.APIURL+"/user/onlinestatus", []byte(util.ToJson(uids)), nil)
	if err != nil {
		return nil, err
	}
